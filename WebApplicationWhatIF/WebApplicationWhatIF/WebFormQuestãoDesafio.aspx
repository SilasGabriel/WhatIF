<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WebFormQuestãoDesafio.aspx.cs" Inherits="WebApplicationWhatIF.WebFormQuestãoDesafio" %>
...
<body>
    ...
    <div>
        ...
        <br />
            <asp:Button ID="Button2" runat="server" Text="Responder" OnClick="Button2_Click"/>
